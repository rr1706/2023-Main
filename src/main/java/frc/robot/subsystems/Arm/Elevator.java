...
public class Elevator extends SubsystemBase {
    ...
    private TrapezoidProfile.State state = new TrapezoidProfile.State(ArmConstants.kDefaultElevator, 0.0);
    ...
    public Elevator(int motorID1, int motorID2) {
        ...
        m_motor1.setSoftLimit(SoftLimitDirection.kForward, (float) ArmConstants.kMinElevator);
        m_motor1.setSoftLimit(SoftLimitDirection.kReverse, (float) ArmConstants.kMaxElevator);
    ...
    public void periodic() {
        ...
        TrapezoidProfile profile = new TrapezoidProfile(ArmConstants.kElevatorConstraints, setpoint, state);
