...
public class Cube extends SubsystemBase {
    ...
    public Cube(int motorID1, int motorID2) {
        ...
        state = new TrapezoidProfile.State(IntakeConstants.kRetractedCube, 0.0);
        setpoint = state;
    }
    ...
    public void extend() {
        setpoint = new TrapezoidProfile.State(IntakeConstants.kExtendedCube, 0.0);
    }

    public void retract() {
        setpoint = new TrapezoidProfile.State(IntakeConstants.kRetractedCube, 0.0);
        m_motor.stopMotor();
    }
    ...
    public void periodic() {
        ...
        TrapezoidProfile profile = new TrapezoidProfile(IntakeConstants.kCubeConstraints, setpoint, state);
