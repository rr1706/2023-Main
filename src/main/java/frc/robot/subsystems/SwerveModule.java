...
public class SwerveModule {
  ...
  public SwerveModule(int driveMotorChannel, int turningMotorChannel, int turningEncoderChannel, double angularOffset,
    ...
    m_turnEncoder.setPositionConversionFactor(2*Math.PI*ModuleConstants.kRotationGearRatio);
    m_turnEncoder.setVelocityConversionFactor(2*Math.PI*ModuleConstants.kRotationGearRatio/60.0);
