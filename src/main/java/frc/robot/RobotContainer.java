...
import frc.robot.commands.AutoHigh;
...
public class RobotContainer {
  ...
  private final AutoHigh m_align = new AutoHigh(m_drive, m_motionControl, m_driverController, m_operatorBoard, m_vision, m_claw);
